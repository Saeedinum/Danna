...
export default class ForgetPassward extends Component {
	render() {
		return (
							...
							<div className='card border-0 bg-white shadow h-100 w-100 p-5' style={{borderRadius: "16px"}}>
								...
								<form action=''>
									<div className='p-4'>
										...
										<input type='email' placeholder='Please Enter Email' className='form-control' id='exampleInputEmail1' aria-describedby='emailHelp' />
									</div>
