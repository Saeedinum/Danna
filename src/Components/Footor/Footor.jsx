				...
				<div className='row gy-4 ms-5'>
					<div className='col-lg-3 col-md-6'>
						...
						<div className='d-flex gap-2 mt-4'>
							<i class='bi bi-geo-alt-fill' style={{color: "rgba(50, 170, 144, 1)"}}></i>
					...
					<div className='col-lg-3 col-md-6'>
						...
						<div className='d-flex gap-2 mt-5'>
							<i class='bi bi-telephone-fill' style={{color: "rgba(50, 170, 144, 1)"}}></i>
					...
					<div className='col-lg-3 col-md-6'>
						...
						<div className='d-flex gap-2 mt-5'>
							<i class='bi bi-envelope-paper-fill' style={{color: "rgba(50, 170, 144, 1)"}}></i>
					...
					<div className='col-lg-3 col-md-6'>
						...
						<div className='d-flex gap-3 mt-5 ms-3'>
							<i class='bi bi-facebook' style={{color: "rgba(50, 170, 144, 1)"}}></i>
							<i class='bi bi-twitter' style={{color: "rgba(50, 170, 144, 1)"}}></i>
							<i class='bi bi-youtube' style={{color: "rgba(50, 170, 144, 1)"}}></i>
						</div>
					</div>
					<hr />
					<p className='text-center'>
						Made With Love <i class='bi bi-balloon-heart-fill' style={{color: "rgba(50, 170, 144, 1)"}}></i>
					</p>
				</div>
			</div>
		</div>
