...
const ImageCoverSkeleton = () => (
	<ContentLoader speed={2} width={400} height={400} viewBox='0 0 400 400' backgroundColor='#dedede' foregroundColor='#ffffff'>
		<circle cx='197' cy='194' r='189' />
	</ContentLoader>
);

const SideImagesSkeleton = () => (
	<ContentLoader speed={2} width={200} height={200} viewBox='0 0 200 200' backgroundColor='#dedede' foregroundColor='#ffffff'>
		<circle cx='65' cy='62' r='57' />
	</ContentLoader>
);

const TitleSkeleton = () => (
	<ContentLoader speed={2} width={500} height={400} viewBox='0 0 500 400' backgroundColor='#dbdbdb' foregroundColor='#ecebeb'>
...
const DescriptionSkeleton = () => (
	<ContentLoader speed={2} width={600} height={400} viewBox='0 0 600 400' backgroundColor='#dbdbdb' foregroundColor='#ecebeb'>
...
export {ImageCoverSkeleton, SideImagesSkeleton, TitleSkeleton, DescriptionSkeleton};
