...
import img from "../../assets/bookdet.png";
import img2 from "../../assets/visa.png";
import icon1 from "../../assets/Payment method icon.png";
import icon2 from "../../assets/Payment method icon (1).png";
import icon3 from "../../assets/Payment method icon (2).png";
